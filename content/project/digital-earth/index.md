...
Dr. Samavati’s team has been very active in the research and development of Digital Earth using DGGS. d hard on these projects, publishing several [peer reviewed papers]({{ < rel "/publication" >}}) from mathematical foundations to practical implications. [One patent]({{< rel "/publication/p3" >}}) has already been published and another has recently been filed. 
